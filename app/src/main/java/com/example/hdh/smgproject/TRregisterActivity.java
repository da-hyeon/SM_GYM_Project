...
//                                                Intent intent = new Intent(TRregisterActivity.this , LoginActivity.class);    //LoginActivity에서 RegisterActivity로 화면전환
//                                                TRregisterActivity.this.startActivity(intent);
                                                finish();
                                            }
                                        })
                                        .create();
